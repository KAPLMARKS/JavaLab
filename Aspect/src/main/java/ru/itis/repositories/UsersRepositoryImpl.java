...
public class UsersRepositoryImpl implements UsersRepository {
    private static final String SQL_SELECT_ALL = "select * from honey.user_table";
    private static final String SQL_SELECT_BY_ID = "select * from honey.user_table where id = ?";
    private static final String SQL_SELECT_LOGIN = "SELECT * FROM honey.user_table WHERE email = ?";
    private static final String SQL_SELECT_CODE = "SELECT * FROM honey.user_table WHERE confirm_code = ?";
    private static final String SQL_INSERT = "insert into honey.user_table(username, email, password, state, confirm_code, role) values (?, ?, ?, ?, ?, ?)";
    private static final String SQL_UPDATE = "UPDATE honey.user_table SET state = ? WHERE email = ?";
    private static final String SQL_DELETE = "DELETE FROM honey.user_table WHERE id = ?";
